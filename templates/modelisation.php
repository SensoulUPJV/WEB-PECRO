    ...
    <div class="container">
        <div class="breadcrumb-content text-center">
            <ul>
                ...
                <li class="active">Modélisation 3D</li>
            </ul>
        </div>
    </div>
</div>
<div class="about-story-area pt-100 pb-50">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="story-img">
                    <a href="#"><img src="media/pages/modelisation-3d-access.jpg" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="story-details pl-50">
                    <?=$contenuPage[array_search("PRESENTATION", array_column($contenuPage, 'identifiant'))]['contenu'];?>
                </div>
            </div>
        </div>
    </div>
